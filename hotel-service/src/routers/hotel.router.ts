...
import { createHotelHandler, fetchHotelsByOwnerIdHandler, findRoomCategoriesByHotelIdHandler, getHotelByIdHandler, softDeleteHotelHandler } from "../controllers/hotel.controller";
